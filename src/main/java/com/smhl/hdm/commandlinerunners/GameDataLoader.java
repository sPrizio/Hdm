...
public class GameDataLoader implements CommandLineRunner {
    ...
    private void loadGameData() {
        ...
        //  skater details
        SkaterGameDetails skaterGameDetails11 = new SkaterGameDetails(skaters.get(0), team1, 1, 0, 9, 0);
        SkaterGameDetails skaterGameDetails12 = new SkaterGameDetails(skaters.get(1), team1, 0, 1, 6, 1);
        SkaterGameDetails skaterGameDetails13 = new SkaterGameDetails(skaters.get(2), team1, 2, 0, 8, 2);
        SkaterGameDetails skaterGameDetails14 = new SkaterGameDetails(skaters.get(3), team1, 0, 1, 10, 0);
        SkaterGameDetails skaterGameDetails15 = new SkaterGameDetails(skaters.get(4), team1, 0, 1, 4, 3);
        SkaterGameDetails skaterGameDetails16 = new SkaterGameDetails(skaters.get(5), team2, 1, 0, 1, 1);
        SkaterGameDetails skaterGameDetails17 = new SkaterGameDetails(skaters.get(6), team2, 0, 0, 8, 4);
        SkaterGameDetails skaterGameDetails18 = new SkaterGameDetails(skaters.get(7), team2, 0, 1, 11, 1);
        SkaterGameDetails skaterGameDetails19 = new SkaterGameDetails(skaters.get(8), team2, 0, 1, 13, 0);
        SkaterGameDetails skaterGameDetails110 = new SkaterGameDetails(skaters.get(9), team2, 1, 0, 7, 6);

        //  goalie details
        GoalieGameDetails goalieGameDetails11 = new GoalieGameDetails(goalies.get(0), team1, true, GameResult.WIN.toString(), 40, 38, 2);
        GoalieGameDetails goalieGameDetails12 = new GoalieGameDetails(goalies.get(1), team2, true, GameResult.LOSS.toString(), 37, 34, 3);

        //  team details
        TeamGameDetails teamGameDetails11 = new TeamGameDetails(team1, GameResult.WIN.toString(), 3, 2);
        TeamGameDetails teamGameDetails12 = new TeamGameDetails(team2, GameResult.LOSS.toString(), 2, 3);
        ...
        //  skater details
        SkaterGameDetails skaterGameDetails21 = new SkaterGameDetails(skaters.get(0), team3, 2, 1, 8, 0);
        SkaterGameDetails skaterGameDetails22 = new SkaterGameDetails(skaters.get(1), team3, 1, 0, 15, 0);
        SkaterGameDetails skaterGameDetails23 = new SkaterGameDetails(skaters.get(2), team3, 0, 1, 21, 1);
        SkaterGameDetails skaterGameDetails24 = new SkaterGameDetails(skaters.get(3), team3, 2, 2, 7, 3);
        SkaterGameDetails skaterGameDetails25 = new SkaterGameDetails(skaters.get(4), team3, 1, 1, 6, 4);
        SkaterGameDetails skaterGameDetails26 = new SkaterGameDetails(skaters.get(5), team1, 0, 1, 13, 1);
        SkaterGameDetails skaterGameDetails28 = new SkaterGameDetails(skaters.get(7), team1, 1, 0, 23, 6);
        SkaterGameDetails skaterGameDetails29 = new SkaterGameDetails(skaters.get(8), team1, 0, 1, 5, 1);
        SkaterGameDetails skaterGameDetails210 = new SkaterGameDetails(skaters.get(9), team1, 0, 0, 8, 2);

        //  goalie details
        GoalieGameDetails goalieGameDetails21 = new GoalieGameDetails(goalies.get(2), team3, true, GameResult.WIN.toString(), 49, 48, 1);
        GoalieGameDetails goalieGameDetails22 = new GoalieGameDetails(goalies.get(3), team1, true, GameResult.LOSS.toString(), 57, 53, 4);

        //  team details
        TeamGameDetails teamGameDetails21 = new TeamGameDetails(team3, GameResult.WIN.toString(), 4, 1);
        TeamGameDetails teamGameDetails22 = new TeamGameDetails(team1, GameResult.LOSS.toString(), 1, 4);
        ...
        //  skater details
        SkaterGameDetails skaterGameDetails31 = new SkaterGameDetails(skaters.get(0), team4, 0, 0, 10, 1);
        SkaterGameDetails skaterGameDetails34 = new SkaterGameDetails(skaters.get(3), team4, 0, 0, 18, 4);
        SkaterGameDetails skaterGameDetails35 = new SkaterGameDetails(skaters.get(4), team4, 0, 0, 9, 5);
        SkaterGameDetails skaterGameDetails36 = new SkaterGameDetails(skaters.get(5), team3, 0, 2, 10, 1);
        SkaterGameDetails skaterGameDetails37 = new SkaterGameDetails(skaters.get(6), team3, 2, 0, 3, 2);
        SkaterGameDetails skaterGameDetails38 = new SkaterGameDetails(skaters.get(7), team3, 0, 1, 4, 4);
        SkaterGameDetails skaterGameDetails310 = new SkaterGameDetails(skaters.get(9), team3, 0, 1, 11, 6);

        //  goalie details
        GoalieGameDetails goalieGameDetails31 = new GoalieGameDetails(goalies.get(4), team4, true, GameResult.WIN.toString(), 28, 28, 0);
        GoalieGameDetails goalieGameDetails32 = new GoalieGameDetails(goalies.get(0), team3, true, GameResult.LOSS.toString(), 47, 45, 2);

        //  team details
        TeamGameDetails teamGameDetails31 = new TeamGameDetails(team4, GameResult.WIN.toString(), 2, 0);
        TeamGameDetails teamGameDetails32 = new TeamGameDetails(team3, GameResult.LOSS.toString(), 0, 2);
        ...
        //  skater details
        SkaterGameDetails skaterGameDetails41 = new SkaterGameDetails(skaters.get(0), team2, 1, 0, 10, 2);
        SkaterGameDetails skaterGameDetails42 = new SkaterGameDetails(skaters.get(1), team2, 2, 0, 14, 2);
        SkaterGameDetails skaterGameDetails43 = new SkaterGameDetails(skaters.get(2), team2, 0, 1, 15, 1);
        SkaterGameDetails skaterGameDetails44 = new SkaterGameDetails(skaters.get(3), team2, 0, 2, 9, 0);
        SkaterGameDetails skaterGameDetails45 = new SkaterGameDetails(skaters.get(4), team2, 0, 2, 6, 0);
        SkaterGameDetails skaterGameDetails46 = new SkaterGameDetails(skaters.get(5), team5, 1, 1, 11, 3);
        SkaterGameDetails skaterGameDetails47 = new SkaterGameDetails(skaters.get(6), team5, 1, 1, 12, 4);
        SkaterGameDetails skaterGameDetails48 = new SkaterGameDetails(skaters.get(7), team5, 0, 1, 4, 0);

        //  goalie details
        GoalieGameDetails goalieGameDetails41 = new GoalieGameDetails(goalies.get(1), team2, true, GameResult.TIE.toString(), 27, 24, 3);
        GoalieGameDetails goalieGameDetails42 = new GoalieGameDetails(goalies.get(2), team5, true, GameResult.TIE.toString(), 54, 51, 3);

        //  team details
        TeamGameDetails teamGameDetails41 = new TeamGameDetails(team2, GameResult.WIN.toString(), 3, 3);
        TeamGameDetails teamGameDetails42 = new TeamGameDetails(team5, GameResult.LOSS.toString(), 3, 3);
        ...
        //  skater details
        SkaterGameDetails skaterGameDetails51 = new SkaterGameDetails(skaters.get(0), team5, 3, 0, 10, 1);
        SkaterGameDetails skaterGameDetails52 = new SkaterGameDetails(skaters.get(1), team5, 0, 1, 11, 6);
        SkaterGameDetails skaterGameDetails54 = new SkaterGameDetails(skaters.get(3), team5, 0, 1, 4, 4);
        SkaterGameDetails skaterGameDetails55 = new SkaterGameDetails(skaters.get(4), team5, 0, 1, 5, 3);
        SkaterGameDetails skaterGameDetails56 = new SkaterGameDetails(skaters.get(5), team4, 0, 0, 11, 1);
        SkaterGameDetails skaterGameDetails59 = new SkaterGameDetails(skaters.get(8), team4, 0, 0, 18, 1);
        SkaterGameDetails skaterGameDetails510 = new SkaterGameDetails(skaters.get(9), team4, 1, 0, 13, 0);

        //  goalie details
        GoalieGameDetails goalieGameDetails51 = new GoalieGameDetails(goalies.get(3), team5, true, GameResult.LOSS.toString(), 42, 39, 3);
        GoalieGameDetails goalieGameDetails52 = new GoalieGameDetails(goalies.get(4), team4, true, GameResult.WIN.toString(), 30, 29, 1);

        //  team details
        TeamGameDetails teamGameDetails51 = new TeamGameDetails(team5, GameResult.WIN.toString(), 1, 3);
        TeamGameDetails teamGameDetails52 = new TeamGameDetails(team4, GameResult.LOSS.toString(), 3, 1);
